...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bloodiey':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('Bloodiey','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'Bloodiey Idle Dance', 24, false);
				animation.addByPrefix('singUP', 'Bloodiey Note Up', 24, false);
				animation.addByPrefix('singRIGHT', 'Bloodiey Note Right', 24, false);
				animation.addByPrefix('singDOWN', 'Bloodiey Note Down', 24, false);
				animation.addByPrefix('singLEFT', 'Bloodiey Note Left', 24, false);
			...
			case 'lasercat':
					// DAD ANIMATION LOADING CODE
					tex = Paths.getSparrowAtlas('lasercat','shared',true);
					frames = tex;
					animation.addByPrefix('idle', 'LaserCatIdle', 24, false);
					animation.addByPrefix('singUP', 'LaserCatSingUp', 24, false);
					animation.addByPrefix('singRIGHT', 'LaserCatSingRight', 24, false);
					animation.addByPrefix('singDOWN', 'LaserCatSingDown', 24, false);
					animation.addByPrefix('singLEFT', 'LaserCatSingLeft', 24, false);
