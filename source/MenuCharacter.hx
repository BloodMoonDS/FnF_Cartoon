...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'lasercat' => new CharacterSetting(0, 100, 0.75),
		'bloodiey' => new CharacterSetting(0, 100, 0.75)
	];
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		animation.addByPrefix('lasercat', "LaserCatIdleMenu", 24, false);
		animation.addByPrefix('bloodiey',"Bloodiey Asset Menu",24,false);
